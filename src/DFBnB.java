...
//						skipped_illegal_move++;
				...
				while(!pq.isEmpty()) {
					...
					//it is predicted to be more expensive to get from this node to the goal, then what the threshold, i.e. what was already found, is at the moment 
...
//						found_goal++;
		...
		//getting here means the stack is empty, and that means no more nodes remain to check, so return the found answer
